...
ALLOWED_HOSTS = [
    ...
    'localhost',  # Stripe webhook listener
    'luxury-shoes-00974b0f1528.herokuapp.com'  # heroku application
]
...
ROOT_URLCONF = 'luxury_shoes.urls'
...
if 'USE_AWS' in os.environ:
    ...
    AWS_STORAGE_BUCKET_NAME = 'luxury-shoes'
...
if 'DEVELOPMENT' in os.environ:
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'noreply@luxury-shoes.com'
else:
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
    EMAIL_USE_TLS = True
    EMAIL_PORT = 587
